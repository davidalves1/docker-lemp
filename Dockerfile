...
RUN apt-get update && apt-get install -q -y ssmtp mailutils zlib1g-dev libicu-dev g++ && rm -rf /var/lib/apt/lists/*

RUN docker-php-ext-install pdo_mysql mysqli sysvsem intl
